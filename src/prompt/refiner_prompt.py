...
class RefinerPrompt(LLMPrompt):
    def __init__(self,language,n_shot_prompt,*args,**kwargs):
        ...
        :param kwargs:
        """
        super(RefinerPrompt, self).__init__(language,n_shot_prompt,*args,**kwargs)
